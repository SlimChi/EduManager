...
import {
    FaPrint, FaCheck, FaRuler, FaDrawPolygon, FaHome,
} from 'react-icons/fa';
...
const GeomAct3Quellogochoisir = () => {
    ...
    const [showCorrections, setShowCorrections] = useState({
        question1: false, question2: false, question3: false, question4: false, question5: false, question6: false,
    });
    ...
    const correctAnswers = {
        ...
        question2: 'Les mesures des angles B et C sont égales dans un triangle isocèle.',
        question3: 'Les trois angles mesurent 60° dans un triangle équilatéral.',
        question4: 'Le triangle doit être rectangle et isocèle.',
        question5: 'Un triangle rectangle est inscrit dans un cercle lorsque ses sommets sont des points du cercle. Le cercle est alors circonscrit au triangle.',
                    ...
                    <div className="d-flex align-items-start gap-3">
                        ...
                        >
                            <img
                                ...
                                className="img-fluid rounded shadow-sm compact-img"
                                onClick={() => openModal(cercleGeoImage, 'Cercle et triangle')}
                            />
                        </div>
                    </div>
