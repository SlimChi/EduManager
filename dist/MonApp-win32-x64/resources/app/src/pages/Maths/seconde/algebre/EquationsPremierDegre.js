...
import {
    FaLock, FaKey, FaCheck, FaQuestionCircle, FaDice, FaChartBar, FaCode,
} from 'react-icons/fa';
...
const EquationsPremierDegre = () => {
    ...
    const correctAnswers = {
        ...
        symbole8: '🖤 = 15', // 5 × 3 = 15
        message: '⭐(20=T) 🎴(21=U) ⬛(5=E) 🔺(19=S) 💀(6=F) 🖤(15=O) 🌙(18=R) ⭐(20=T) → "TU ES FORT" ',
    };
    ...
    const steps = ["1 → Isoler le terme contenant l'inconnue", "2 → Diviser par le coefficient de l'inconnue", "3 → Vérifier la solution en remplaçant dans l'équation",];
        ...
        <div className="tp-container" id="equations-content" ref={contentRef}>
            ...
            <div className="print-page">
                <header className="tp-header">
                    ...
                    <h1>🧩 Équations premier degré - Classe 2MRC Mathématiques</h1>
                </header>
                <Automatismes/>
                        ...
                        <div className="math-chapter-decoration">
                            <svg width="100" height="80" viewBox="0 0 24 24" fill="none">
                                <path
                                    ...
                                    stroke="#ff9500"
                                    strokeWidth="2"/>
                                <circle cx="12" cy="12" r="10" stroke="#ff5e00"
                                        strokeWidth="1.5"/>
                                <path
                                    d="M12 8V16 M8 12H16" stroke="#ff9500" strokeWidth="2"
                                />
                            </svg>
                        </div>
                    </div>
                ...
                <div className="d-flex align-items-start flex-wrap" style={{gap: '20px'}}>
                    ...
                    <div
                        ...
                        style={{
                            maxWidth: '350px', cursor: 'pointer', marginTop: '90px',
                        }}
                    >
                        <img
                            src={hacker}
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole3', e.target.value)}
                                />
                                <button
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole1', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole4', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole2', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole5', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole6', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole7', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
                            ...
                            <td>
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('symbole8', e.target.value)}
                                />
                                <button
                                    className="correction-btn3"
            ...
            <div className="print-page">
                ...
                <section className="tp-section2">
                    ...
                    <div className="retien-box">
                        ...
                        {activeSteps.includes(1) && (<div className="summary-content">
...
export default EquationsPremierDegre;
