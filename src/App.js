...
import Act2IndicateurDeDisp from "./pages/Maths/seconde/statistiques/statistiques/Act2IndicateurDeDisp";
import ActCoInterventionCalculCommerciaux2
            ...
            <div className="main-content">
                ...
                <div className="page-content">
                    <Routes>
                        ...
                        />
                        <Route
                            path="/programmes/math/:classId/ProgrammeSecondeMaths/activites/statistiques/Act2IndicateurDeDisp"
                            element={<Act2IndicateurDeDisp/>}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path="/programmes/math/:classId/ProgrammeSecondeMaths/activites/cointervention/ActCoInterventionCalculCommerciaux2"
                            element={<ActCoInterventionCalculCommerciaux2/>}
                        />
                        <Route
                            path="/programmes/math/:classId/ProgrammeSecondeMaths/activites/cointervention/ActCoInterventionCalculCommerciaux3"
                            element={<ActCoInterventionCalculCommerciaux3/>}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path="/programmes/science/:classId/ProgrammeSecondePhysique/activites/mecanique/EvaluationMeca"
                            element={<EvaluationMeca/>}
                        />
                        <Route
                        ...
                        />
                        <Route
                            path="/programmes/science/:classId/ProgrammePremierePhysique/activites/electricite/act3Electricite"
                            element={<Act3Electricite1ere/>}
                        />
                        <Route
                            path="/programmes/science/:classId/ProgrammePremierePhysique/activites/electricite/BilanElectricite"
                            element={<BilanElectricite/>}
                        />
                        <Route
