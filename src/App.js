        ...
        <div className="main-content">
          ...
          <div className="page-content">
            <Routes>
              ...
              <Route
                path={
                  '/programmes/math/:classId/ProgrammeSecondeMaths/activites/geometrie/GeometrieAct1'
                }
                element={<GeometrieAct1 />}
              />
              <Route
                path={
                  '/programmes/math/:classId/ProgrammeSecondeMaths/activites/geometrie/GeometrieAct2'
                }
                element={<GeomAct2 />}
              />
              <Route
