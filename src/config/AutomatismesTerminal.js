...
import {AutomatismesTerminaleDb} from "./AutomatismesTerminaleDb";

const AutomatismesTerminal = () => {
    // États
    ...
    const generateQuestions = (seed) => {
        const shuffled = [...AutomatismesTerminaleDb].sort((a, b) => {
                                ...
                                <div className="answer-display">
                                    ...
                                    {selectedQuestions[index].detailedAnswer && (
                                        <div className="detailed-answer">
                                            <span>Explication :</span> {selectedQuestions[index].detailedAnswer}
                                        </div>
                                    )}
                                    {userAnswers[index] && (
...
export default AutomatismesTerminal;