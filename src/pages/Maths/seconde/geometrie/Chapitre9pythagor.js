...
const Chapitre9Pythagor = () => {
    ...
    return (
        ...
        <div className="tp-container" id="pythagore-content" ref={contentRef}>
                ...
                <div className="tp-intro">
                    ...
                    <div className="d-flex align-items-start" style={{ gap: '20px' }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <p>
                                Ce chapitre explore les théorèmes fondamentaux pour le calcul des longueurs en géométrie.
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div className="activity-content">
                                        <div className="question">
                                            ...
                                            <div className="answer-container">
                                                ...
                                                />
                                                <button className="correction-btn" onClick={() => toggleCorrection('question1a')}>
                                                    <FaCheck /> Correction
                                                </button>
                                            </div>
                                        </div>
            ...
            />
                                                <button className="correction-btn" onClick={() => toggleCorrection('question1b')}>
                                                    <FaCheck /> Correction
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div className="activity-card">
                                    ...
                                    <div className="activity-content">
                                        ...
                                        <div className="answer-container">
                                            ...
                                            />
                                            <button className="correction-btn" onClick={() => toggleCorrection('question2')}>
                                                <FaCheck /> Correction
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <div className="question-column">
                                                <div className="question">
                                                    ...
                                                    <div className="answer-container">
                                                        ...
                                                        <button className="correction-btn" onClick={() => toggleCorrection('question3a')}>
                                                            <FaCheck /> Correction
                                                        </button>
                                                        {showCorrections.question3a && (
                                                            <div className="correction-text">
                                                                <p>Correction : La bonne réponse est "les droites (BC) et (DE) n'ont pas de point d'intersection"</p>
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                            ...
                            />
                                                        <button className="correction-btn" onClick={() => toggleCorrection('question3b')}>
                                                            <FaCheck /> Correction
                                                        </button>
                                                        {showCorrections.question3b && (
                                                            <div className="correction-text">
                                                                <p>Correction :</p>
                                                                <ul>
                                                                    <li>Une droite parallèle à (AB) : (AB) // (HI)</li>
                                                                    <li>La droite parallèle à (BC) passant par D : (DE)</li>
                                                                </ul>
                                                            </div>
                                                        )}
                                                    </div>
