...
const ExercicesFonctionCarre = () => {
    ...
    const correctAnswers = {
        ...
        ex1_3: {
            left: "Décroissante (flèche descendante de -3 à 0)",
            right: "Croissante (flèche montante de 0 à 2)"
        },
        ex2_1: "x ≈ -3",
        ex2_2: "x ≈ -1 et x ≈ 2,5 ",
            ...
            <div className="tp-container act1-container function-theme" id="proba-content" ref={contentRef}>
                        ...
                        <div className="question compact">
                            ...
                            <div className="sample-table-container">
                                <table className="sample-table">
                                    ...
                                    <tr>
                                        <td>f(x) = 0,5x²</td>
                                        {answers.ex1_1.map((answer, index) => (
                                            <td key={index}>
                                                <input
                                                    type="text"
                                    ...
                                    <tr>
                                        ...
                                        <td style={{
                                            ...
                                            {showCorrections.ex1_3 ? (
                                                <div className="correction-text">{correctAnswers.ex1_3.left}</div>
                                            ) : (
                                                <input
                                                    type="text"
                                                    className="answer-input compact"
                                                    value={answers.ex1_3.left}
                                                    onChange={(e) => handleInputChange('ex1_3', {left: e.target.value})}
                                                />
                                            )}
                                        </td>
                                        <td style={{
                                            ...
                                            {showCorrections.ex1_3 ? (
                                                <div className="correction-text">{correctAnswers.ex1_3.right}</div>
                                            ) : (
                                                <input
                                                    type="text"
                                                    className="answer-input compact"
                                                    value={answers.ex1_3.right}
                                                    onChange={(e) => handleInputChange('ex1_3', {right: e.target.value})}
                                                />
                                            )}
                                        </td>
                                    </tr>
                ...
                <div className="print-page">
                    ...
                    <section className="tp-section compact">
                        ...
                        <div className="question compact">
                            ...
                            <div className="sample-table-container">
                                <table className="sample-table">
                                    ...
                                    <tr>
                                        <td>f(x) = 0,1x² (W)</td>
                                        {answers.ex3_1.map((answer, index) => (
                                            <td key={index}>
                                                <input
                                                    type="text"
                        ...
                        <div className="question compact">
                            <p className="compact-text">3.2. Représentation graphique :</p>
                            <div
                            ...
                            >
                                ...
                                <p className="text-muted">Cliquez pour agrandir</p>
                            </div>
                        </div>
                ...
                <div className="print-page">
                    ...
                    <section className="tp-section compact">
                        ...
                        <div className="renovation-contexte">
                            <p>
                                La puissance P (en kW) d'une éolienne se calcule par P = 0,20 × D² où D est le diamètre
                                (en m) de la surface balayée par les pales.
                            </p>
                        </div>
                        ...
                        <div className="question compact">
                            ...
                            <div className="sample-table-container">
                                <table className="sample-table">
                                    ...
                                    <tr>
                                        <td>f(x) = 0,20x²</td>
                                        {answers.ex4_2a.map((answer, index) => (
                                            <td key={index}>
                                                <input
                                                    type="text"
                        ...
                        <div className="conclusion-container">
                            {showConclusion ? (
                                <div className="info-bubble warning">
                                    <div className="info-bubble-title"><FaChartLine/> Bilan</div>
                                    <p>
                                        La fonction carré et ses variations sont fondamentales en mathématiques et dans
                                        de nombreuses applications physiques. Ces exercices montrent comment modéliser
                                        des
                                        situations concrètes (puissance électrique, énergie éolienne) à l'aide de
                    ...
                    <div className="modal-overlay" onClick={closeGraphModal}>
                        <div className="modal-content" onClick={e => e.stopPropagation()}>
                            ...
                            <p className="text-center mt-3">
                                {!showCorrections[`ex${currentGraph.split('ex')[1]}_1`] &&
                                    "Cliquez sur 'Correction' pour afficher les solutions"}
                            </p>
                        </div>
                    </div>
                )}
