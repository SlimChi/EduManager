                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="question-card">
                            ...
                            <h4 className="vect-title">Question n°1 : Mesure de la profondeur</h4>
                            ...
                            <h4 className="vect-title">Question n°2 : Respect de la réglementation</h4>
                            <div className="question-content">
                            ...
                            <h4 className="vect-title">Question n°3 : Calcul du diamètre</h4>
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="question-card">
                            ...
                            <h4 className="vect-title mt-2">Question n°4 : Calcul du périmètre</h4>
                            <div className="question-content">
                            ...
                            <h4 className="vect-title mt-2">Question n°5 : Longueur de 10 périmètres</h4>
                            <div className="question-content">
                            ...
                            <h4 className="vect-title">Question n°6</h4>
                            <div className="question-content">
                                {/* Question 1 */}
                                <div className="mb-4">
