...
const ExerciceProba = () => {
    ...
    const correctAnswers = {
        ...
        ex6a2: '10%',
        ex6a3: '6,25%',
        ex6b: 'Oui : 56,25% des voitures n\'ont aucune panne',
        ex7a: '51',
        ex7b: '51%',
        ex7c: '49',
        ex7d: '49%',
        ...
        ex107: '9',
        ex108: '13',
        ex10c: '1/8 = 0,125 ou 12,5%',
        ex11a: '8 issues possibles',
        ex11b: 'PPF, PFP, FPP',
        ex11c: '3/8 = 0,375',
        ex12a1: 'from random import *',
        ex12a2: 'x=randint(1,6)',
        ex12a3: 'if x==6:',
        ex12a4: 'print("gagné 6 €")',
        ex12a5: 'else:',
        ex12a6: 'print("perdu 1 €")',
        ex12b: '-1 -1 -1 -1 -1 -1 -1 -1 -1 6',
        ex12c: 'Perte de 3 €'
    };
        ...
        <>
            ...
            >
                    ...
                    <section className="exercises-section">
                        ...
                        <div className="exercise-box info-bubble">
                            <h4 className="exercise-title">
                                <FaDice/> 5. Fréquence de sortie du nombre 7
                            </h4>
                            <p>On simule le lancer de deux dés avec 100 nombres aléatoires entre 2 et 12 :</p>
                            <p className="small-text text-center">10 ; 2 ; 7 ; 6 ; 7 ; 5 ; 8 ; 3 ; 11
                                ; 10 ;
                                8 ; 11 ; 6 ; 3 ; 4 ; 11
                                ; 6 ; 6 ; 11 ; 3 ; 2 ; 5 ; 6 ; 9 ; 12 ; 2 ; 2 ; 11 ; 2 ; 6 ; 7 ; 9 ; 5 ; 5 ; 3 ; 2 ; 10
                                ; 6 ; 7 ; 3 ; 11 ; 7 ; 5 ; 7 ; 11 ; 5 ; 12 ; 5 ; 6 ; 3 ; 10 ; 6 ; 7 ; 9 ; 10 ; 8 ; 3 ; 3
                                ; 9 ; 7 ; 9 ; 10 ; 7 ; 4 ; 3 ; 9 ; 8 ; 12 ; 4 ; 8 ; 12 ; 9 ; 10 ; 4 ; 8 ; 4 ; 2 ; 10 ;
                                11 ; 7 ; 6 ; 10 ; 11 ; 4 ; 7 ; 2 ; 12 ; 9 ; 3 ; 7 ; 11 ; 10 ; 8 ; 5 ; 5 ; 2 ; 7 ; 11 ; 2
                                ; 1.</p>

                            <div className="d-flex flex-wrap" style={{gap: '20px'}}>
                                <div className="question-card" style={{flex: '1', minWidth: '250px'}}>
                                    <p className="question-text">a. Fréquence de 7 sur les 10 premiers nombres :</p>
                                    <input
                                        type="text"
                                ...
                                <div className="question-card" style={{flex: '1', minWidth: '250px'}}>
                                    <p className="question-text">b. Fréquence de 7 sur les 100 nombres :</p>
                                    <input
                                        type="text"
                                        className="answer-input"
                                        value={answers.ex5b}
                        ...
                        <div className="exercise-box info-bubble">
                            <h4 className="exercise-title">
                                <FaTable/> 6. Fréquence de pannes automobiles
                            </h4>
                            <div className="d-flex flex-wrap" style={{gap: '20px'}}>
                                <div style={{flex: '1', minWidth: '300px'}}>
                                    ...
                                    <div className="question-card mt-3">
                                        ...
                                        {showAnswers.ex6a && (
                                            <div className="correction-box">
                                                <strong>Correction :</strong> f(0) = {correctAnswers.ex6a0}, f(1)
                                                = {correctAnswers.ex6a1}, f(2) = {correctAnswers.ex6a2}, f(3)
                                ...
                                <div style={{flex: '1', minWidth: '300px'}}>
                                    ...
                                    <div className="question-card">
                                        <p className="question-text">b. L'annonce du fabricant est-elle confirmée ?</p>
                                        <input
                                            type="text"
                                            className="answer-input"
                                            value={answers.ex6b}
                ...
                <div className="print-page">
                    <section className="exercises-section">
                        ...
                        <div className="exercise-box info-bubble">
                            ...
                            <div className="d-flex flex-wrap" style={{gap: '20px'}}>
                                <div className="question-card" style={{flex: '1', minWidth: '250px'}}>
                                    <p className="question-text">a. [1 ; 5] :</p>
                                    <input
                                        type="text"
                                        className="answer-input"
                                        value={answers.ex8a}
                                ...
                                <div className="question-card" style={{flex: '1', minWidth: '250px'}}>
                                    <p className="question-text">b. [0 ; 10] :</p>
                                    <input
                                        type="text"
                                        className="answer-input"
                                        value={answers.ex8b}
                                ...
                                <div className="question-card" style={{flex: '1', minWidth: '250px'}}>
                                    <p className="question-text">c. [5 ; 10] :</p>
                                    <input
                                        type="text"
                                        className="answer-input"
                                        value={answers.ex8c}
                        ...
                        <div className="exercise-box info-bubble">
                            <h4 className="exercise-title">
                                <FaCalculator/> 9. Simulation de tirage de lettres
                            </h4>
                            <p>Une boîte contient les 26 lettres de l'alphabet, de A à Z. Une lettre est tirée au
                                hasard, elle est notée puis remise dans la boîte. Donner l'instruction à la calculatrice
                                pour simuler cette
                                expérience :</p>
                            <input
                                type="text"
                        ...
                        <div className="exercise-box info-bubble">
                            <h4 className="exercise-title">
                                <FaTable/> 10. Simulation de tirages de jetons
                            </h4>
                            <p>Une boîte contient 8 jetons numérotés 1 ; 2 ; 3 ; 4 ; 5 ; 6 ; 7 et 8. Un jeton est tiré
                                au hasard, on note son numéro et il est remis dans la boîte. <br/> À l’aide d’un
                                tableur,
                                simuler 100 tirages d’un jeton et afficher la fréquence de chaque numéro.</p>
                            <div className="d-flex flex-wrap" style={{gap: '20px'}}>
                                <div style={{flex: '1', minWidth: '300px'}}>
                ...
                <div className="print-page">
                    ...
                    <div className="exercise-box info-bubble">
                        <h4 className="exercise-title">
                            <FaDice/> 11. Jeu de pile ou face
                        </h4>
                        <p>Jason et Rachid lancent une pièce trois fois de suite. À chaque pile, le joueur gagne 4
                            points et à chaque face il perd 3 points.</p>

                        <div className="tree-structure">
                            {showCorrections.tree2 ? (
                                <pre>
                                                {`1er lancer     2e lancer      3e lancer       Résultat (Points)
                                        P
                                        ├── P
                                        │   ├── P   → P-P-P 
                                        │   └── F   → P-P-F 
...
`}
                        ...
                        <div className="d-flex flex-wrap" style={{gap: '20px'}}>
                            ...
                            <div style={{flex: '1', minWidth: '300px'}}>
                                <p className="question-text">b. Issues donnant 5 points :</p>
                                <input
                                    type="text"
                                    className="answer-input"
                                    value={answers.ex11b}
                            ...
                            <div style={{flex: '1', minWidth: '300px'}}>
                                <p className="question-text">c. Probabilité d'obtenir 5 points :</p>
                                <input
                                    type="text"
                                    className="answer-input"
                                    value={answers.ex11c}
