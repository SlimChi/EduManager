...
const Act2IndicateurDeDisp = () => {
    ...
    const correctAnswers = {
        question1: "JO 2012 : 8 nageurs (7 temps + 1 disqualifié)\nJO 2016 : 8 nageurs",
        question2a: "Les indicateurs qui renseignent sur la rapidité sont la moyenne et la médiane.",
        question2b: "Non, on ne peut pas en déduire clairement la finale la plus rapide car la moyenne et la médiane ne donnent pas la même indication (2012: moyenne 10,14 > médiane 9,88; 2016: moyenne 9,94 = médiane 9,94).",
        question3a: "Les indicateurs qui permettent de savoir quelle finale a été la plus serrée sont l'écart interquartile (Q3 - Q1) et l'écart type σ.",
        question3b: "Oui, la finale de 2016 est la plus serrée car ses indicateurs de dispersion sont plus faibles (écart interquartile: 0,07 s vs 0,23 s; écart type: 0,08 s vs 0,76 s).",
        question4a: "Après suppression du temps aberrant (11,99 s) en 2012:\n- Moyenne = 9,83 s\n- Médiane = 9,84 s\n- Q3 - Q1 = 0,19 s\n- Écart type = 0,12 s",
        question4b: "Les indicateurs les plus modifiés sont la moyenne (10,14 → 9,83) et l'écart type (0,76 → 0,12).",
        question5: "Problématique:\n• Finale la plus rapide: 2012 (après suppression du temps aberrant ou en considérant la médiane)\n• Finale la plus serrée: 2016 (écart interquartile et écart type plus faibles)"
    };
                    ...
                    <div className="activity-header mt-0">
                        ...
                        <div className="activity-title">
                            <span className="course-title">
                                <FaCalculator/> <FaSwimmer/> « Comparer des séries statistiques avec des indicateurs »
                            </span>
                        </div>
                    </div>
                        ...
                        <div style={{flex: 1, minWidth: '350px'}}>
                            <div className="renovation-contexte">
                                <h5 className="mb-3 text-primary fw-bold">
                                    🏊‍♂️ "Finales du 100 m nage libre aux JO"
                                </h5>

                                <p style={{textAlign: 'justify', fontSize: '11px', lineHeight: '1.3'}}>
                                    Michael Phelps est l'un des plus grands nageurs de l'histoire, avec de nombreux
                                    titres olympiques.
                                    Lors des Jeux Olympiques de 2012 et 2016, les finales du 100 m nage libre ont offert
                                    un spectacle exceptionnel.
                                    Les temps (en secondes) réalisés par les nageurs lors de ces finales sont rassemblés
                                    ci-dessous :
                                </p>

                                <div className="data-grid-container mt-3 mb-3">
                                    <div className="data-series">
                                        <h6 style={{fontSize: '11px', color: '#2c3e50', marginBottom: '8px'}}>JO 2012
                                            :</h6>
                                        <div className="data-grid-single-line" style={{
                                            ...
                                            {['9,63', '9,75', '9,79', '9,88', '9,94', '9,98', '11,99', 'Disqualifié'].map((val, i) => (
                                    ...
                                    <div className="data-series mt-2">
                                        <h6 style={{fontSize: '11px', color: '#2c3e50', marginBottom: '8px'}}>JO 2016
                                            :</h6>
                                        <div className="data-grid-single-line" style={{
                                            display: 'flex',
                                            flexWrap: 'wrap',
                                ...
                                <div className="problematique-box" style={{
                                    ...
                                    <p style={{fontSize: '11px', margin: '0', color: '#2c3e50'}}>
                                        • Quelle finale a été la plus rapide ?<br/>
                                        • Quelle finale a été la plus serrée (temps les moins dispersés) ?
                                    </p>
                                </div>
                                ...
                                <div className="objectif-box" style={{
                                    ...
                                    <div className="objectif-title" style={{fontSize: '11px', color: '#856404'}}>
                                        <strong style={{color: 'orangered'}}>Objectif :</strong> 🎯 Comparer des séries
                                        statistiques à l'aide des indicateurs de position et de dispersion.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="question-card mt-1 mb-0" style={{
                            ...
                            <div className="question-item" style={{
                                ...
                                <div style={{flex: 1, minWidth: '250px'}}>
                                    <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                        Combien de nageurs ont participé à chaque finale ?
                                    </p>
                                ...
                                <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                                    ...
                                    >
                                        ...
                                        {showCorrections.question1 ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="question-content">
                            ...
                            <p style={{display: 'inline', textAlign: 'justify', fontSize: '11px', color: '#7f8c8d'}}>
                                Complétez le tableau ci-dessus avec les indicateurs de position et de dispersion
                                (arrondir à 0,01 s).
                            </p>
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    a) Analyser/Raisonner : Quels indicateurs renseignent sur la rapidité des finales ?
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                    marginTop: '8px',
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '8px'}}>
                                    ...
                                    >
                                        <FaCheck style={{marginRight: '4px'}}/>
                                        {showCorrections.question2a ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    b) Valider : Pouvez-vous en déduire la finale la plus rapide ? Justifiez.
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                    marginTop: '8px',
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '8px'}}>
                                    ...
                                    >
                                        <FaCheck style={{marginRight: '4px'}}/>
                                        {showCorrections.question2b ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    a) Analyser/Raisonner : Quels indicateurs permettent de savoir quelle finale a été
                                    la plus serrée ?
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '8px'}}>
                                    ...
                                    >
                                        <FaCheck style={{marginRight: '4px'}}/>
                                        {showCorrections.question3a ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    b) Valider : Pouvez-vous en déduire la finale la plus serrée ? Justifiez.
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                    marginTop: '8px',
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '8px'}}>
                                    ...
                                    >
                                        <FaCheck style={{marginRight: '4px'}}/>
                                        {showCorrections.question3b ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div className="print-page">
                    <div className="question-card mt-1 mb-0" style={{
                        ...
                        <div className="question-content">
                            ...
                            <p style={{textAlign: 'justify', fontSize: '11px', color: '#7f8c8d', marginBottom: '15px'}}>
                                Lors de la finale de 2012, un nageur a eu un incident et a terminé en 11,99 s, un temps
                                aberrant.
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    a) Réaliser : Recalculez les indicateurs de 2012 (arrondir à 0,01 s) :
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                    marginTop: '8px',
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '8px'}}>
                                    ...
                                    >
                                        <FaCheck style={{marginRight: '4px'}}/>
                                        {showCorrections.question4a ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    b) Valider : Quels indicateurs sont les plus modifiés ?
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                    marginTop: '8px',
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '8px'}}>
                                    ...
                                    >
                                        <FaCheck style={{marginRight: '4px'}}/>
                                        {showCorrections.question4b ? '✕ Cacher' : '✓ Voir'}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="question-item" style={{
                                ...
                                <p style={{margin: '0', fontSize: '11px', fontWeight: 'bold', color: '#2c3e50'}}>
                                    5) Valider – Communiquer : Répondez à la problématique.
                                </p>
                                <div className="answer-line" style={{
                                    borderBottom: '1px dashed #ccc',
                                    marginTop: '8px',
                    ...
                    <div className="conclusion-box mt-3" style={{
                        ...
                        <p style={{fontSize: '11px', color: '#155724', margin: '0'}}>
                            Cette activité montre l'importance de choisir les bons indicateurs statistiques selon le
                            contexte.
                            La moyenne est sensible aux valeurs extrêmes, tandis que la médiane est plus robuste.
                            Pour mesurer la dispersion, l'écart interquartile et l'écart type sont complémentaires.
                        </p>
                    </div>
                </div>
