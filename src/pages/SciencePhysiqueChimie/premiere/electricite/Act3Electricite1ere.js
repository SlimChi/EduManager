...
const Act3Electricite1ere = () => {
    ...
    const correctAnswers = {
        etape1: 'Je pense comme Estelle : les appareils en veille entraînent une importante surconsommation.',
        etape2: 'Je mesure les puissances consommées de l\'ordinateur en veille et en fonctionnement et je calcule les énergies respectives.',
        etape3: 'Pour l\'unité centrale, les haut-parleurs et l\'écran en veille, la puissance consommée est de 9 W. En fonctionnement, la puissance est de 74 W. Éteint: 0 W.',
        etape4: 'La surconsommation due à la veille peut être calculée en comparant l\'énergie consommée en veille vs éteint sur une période donnée.',
        etape5: 'L\'hypothèse d\'Estelle est correcte - les appareils en veille consomment effectivement de l\'énergie et contribuent à la surconsommation électrique.',
    };
                ...
                <section className="tp-section compact">
                    <div className="activity-header mt-0">
                        ...
                        <div className="activity-title">
                            <span className="course-title">
                                      « Évaluer la surconsommation due aux appareils en veille »
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="d-flex align-items-start flex-wrap" style={{gap: '20px', marginBottom: '20px'}}>
                        <div style={{flex: 1, minWidth: '300px'}}>
                            <div className="renovation-contexte2">
                                <h5 className="mb-3 text-primary fw-bold">🌍 "Réduire son empreinte écologique"</h5>
                                <p style={{textAlign: 'justify', fontSize: '15px', lineHeight: '1.4'}}>

                                    Lucas, un jeune ado passionné d’informatique et de jeux vidéo, passe beaucoup de
                                    temps devant son ordinateur.
                                    Un jour, il découvre que laisser son PC et ses équipements en veille provoque une
                                    surconsommation d’électricité non négligeable.
                                    <br/>
                                    Curieux et soucieux de comprendre son impact, il décide d’utiliser un consomètre.
                                    Il relève alors la puissance consommée par son ordinateur pendant 7 heures en
                                    veille,
                                    puis la compare à celle mesurée pendant 5 heures d’utilisation.
                                </p>
                                ...
                                <div className="problematique-box" style={{
                                    ...
                                    <p style={{fontWeight: 'bold', fontSize: '12px'}}>
                                        L’objectif est de mesurer et comparer la consommation électrique d’un ordinateur
                                        en veille
                                        et en utilisation.
                                    </p>
                                </div>
                    ...
                    <div className="question-card" style={{marginTop: '-20px', marginBottom: '-20px'}}>
                        <div className="question-header" style={{
                            ...
                            <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                                ...
                                <h4 className="vect-title2" style={{margin: 0, color: '#0d47a1'}}>
                                    ÉTAPE 1 - Je formule une hypothèse
                                </h4>
                            </div>
                        </div>
                        ...
                        <div className="question-content" style={{padding: '15px'}}>
                            ...
                            <div className="qcm-container">
                                {[
                                    ...
                                    'Je pense comme Estelle : les appareils en veille entraînent une importante surconsommation.',
                                    'Je ne sais pas.'
                                ].map((option, index) => (
                        ...
                        <div className="question-header" style={{
                            ...
                            <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                                ...
                                <h4 className="vect-title2" style={{margin: 0, color: '#e65100'}}>
                                    ÉTAPE 2 - Je propose un protocole expérimental
                                </h4>
                            </div>
                        </div>
                        ...
                        <div className="question-content" style={{padding: '5px'}}>
                            <p>
                                <strong>Cocher la bonne réponse.</strong>
                            </p>

                            <div className="qcm-container" style={{marginBottom: '5px'}}>
                                {[
                                    'Je mesure la puissance consommée de l\'ordinateur en veille.',
                                    'Je mesure les puissances consommées de l\'ordinateur en veille et en fonctionnement et je calcule les énergies respectives.',
                                    'Je calcule 10 % de la puissance consommée par l\'ordinateur.'
                                ].map((option, index) => (
                                    <div key={index} className="qcm-option">
                                        <label className="radio-label">
                                            <input type="checkbox" className="radio-input"/>
                    ...
                    <div className="two-columns-container" style={{
                            ...
                            <div className="question-content" style={{padding: '15px'}}>
                                <div style={{marginBottom: '15px'}}>
                                    <p style={{marginBottom: '15px'}}>
                                        <strong>Mesurer et noter les résultats.</strong>
                                    </p>
                                ...
                                {/*    <img src={consommetreImage} alt="Consomètre"*/}
                                {/*         className="img-fluid rounded shadow-sm"*/}
                                {/*         onClick={() => openModal(consommetreImage, 'Consomètre')}*/}
                        ...
                        <div className="question-card">
                            ...
                            <div className="question-content" style={{padding: '15px'}}>
                                <p style={{marginBottom: '15px'}}>
                                    <strong>Évaluer la surconsommation due à la veille des appareils.</strong>
                                </p>
